...
WP-Members 3.4.7 is a minor update. 3.4.7.3 is a bug fix release for all users. Backup prior to upgrading is recommended, but rollback is possible. See changelog for a list of updates. Minimum WP version is 4.0.
...
* Fixes a 3.7.2 bug that throws a php error when saving settings in the main options tab.

= 3.4.7.2 =

* Fixes bug in 3.7.2 that causes custom fields array to be overwritten as empty when updating fields in the plugin's Fields tab.
* Additional fixes for WooComemrce integration.  Fixes issues with updating WP-Members WooCommerce integration settings in the main WP-Members options tab.
